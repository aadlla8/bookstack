...
<div class="content">
    ...
    <form action="/Courses/update/{{$course->id}}" method="POST" enctype="multipart/form-data">
        ...
        @endforeach
        <div class="from-group">
            <input type="hidden" value="0" name="cost" id="cost" required class="form-control" placeholder="In Dollars" value="{{$course->cost}}" />
        </div>
        ...
        <div class="from-group">
            <input type="hidden" value="1" name="NumberOfHours" required id="NumberOfHours" class="form-control" value="{{$course->numOfHours}}" />
        </div>
